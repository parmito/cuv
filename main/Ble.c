...
#define SAMPLE_DEVICE_NAME          "TBOX"
...
static const uint8_t spp_adv_data[14] = {
    0x02,0x01,0x06,
    0x03,0x03,0xE0,0xFF,
    0x05,0x09,0x54,0x42,0x4F,0x58
};
...
static uint8_t  heartbeat_s[4] = {'T','B','O','X'};
            ...
            if(p_data->write.is_prep == false){
               /* ESP_LOGI(GATTS_TABLE_TAG, "ESP_GATTS_WRITE_EVT : handle = %d\n", res);*/
                if(res == SPP_IDX_SPP_COMMAND_VAL){
                	...
                	if(strstr((const char*)spp_cmd_buff,"CAN:") != NULL)
                	{
						/* Receive data over BT and printout over UART*/
						stBleMsg.ucSrc = SRC_BLE;
						stBleMsg.ucDest = SRC_IO;
						stBleMsg.ucEvent = EVENT_IO_ADD_CAN_MESSAGE;
						stBleMsg.pcMessageData = (char*)spp_cmd_buff;

						xQueueSend( xQueueIo, ( void * )&stBleMsg, NULL);
                	}
...
#endif
    xTaskCreate(vTaskBle, "vTaskBle", 2048, NULL, configMAX_PRIORITIES-2, NULL);
}
